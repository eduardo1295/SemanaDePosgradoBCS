...
var nuevooo = function(){
    ...
    $('#'+auxid).after('<div class="row sliderQuitar nr" id="nuevorenglon_'+(x+1)+'">'+
                        ...
                        '<label for="posgrado" class="control-label">Posgrado</label></strong> <select class="form-control posgrado" id="posgrado'+x+
                        '" name="posgrado"><option selected value="">Seleccione posgrado</option><option value="Maestría">Maestría</option><option value="Doctorado">Doctorado</option></select><small><span class="text-danger mensajeError errorposgrado" id="posgrado.'+(x)+'_error"></span></small></div>'+
                        '<div class="form-group col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3"><strong><label for="periodo" class="control-label">Periodo</label></strong><select class="form-control periodo" id="periodo" name="periodo"><option selected value="">Seleccione periodo</option><option value="Trimestre">Trimestre</option><option value="Cuatrimestre">Cuatrimestre</option><option value="Semestre">Semestre</option></select><small><span class="text-danger mensajeError errorperiodo" id="periodo.'+x+'_error"></span></small></div>'+

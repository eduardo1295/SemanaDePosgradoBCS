                ...
                <div class="col-12 mx-auto">
                        <form id="constanciaForm" name="constanciaForm" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group row">
                                    <label for="logo" class="col-3 col-form-label">Imagen de Fondo</label>
                                    <div class="custom-file col-7">
                                            <input type="file" name="fondo" class="custom-file-input" id="fondo" lang="es"  onchange="readURL(this,'vistaPrevia');">
  ...
  <script>
    ...
    var componenetes = "";
      ...
      if(constancia[0].url_imagen_fondo != ""){
        var unique = $.now();
        $(".gjs-frame").contents().find("#wrapper").css('background-image', 'url("'+constancia[0].url_imagen_fondo+ '/?' + unique+'")');
          ...
          $('.btnGuardarDiseno').html('Guardando...');
              ...
              $.ajax({
                  ...
                  success: function (data) {
                      ...
                      var unique = $.now();
                      $(".gjs-frame").contents().find("#wrapper").css('background-image', 'url("'+data.url_imagen_fondo+ '/?' + unique+'")');
                      $(".gjs-frame").contents().find("#wrapper").css('background-size', '100% 100%');
                      $(".gjs-frame").contents().find("#wrapper").css('background-repeat', 'no-repeat');
...
<link rel="stylesheet" href="{{ asset('/plugins/grapesjs/css/grapes.min.css') }}">
    <style>
      ...
      .gjs-clm-tags, .gjs-devices-c, .gjs-pn-devices-c { display: none !important }
      .gjs-pn-views {

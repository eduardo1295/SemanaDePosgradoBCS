...
@section('contenido')
	<div class="container" style="width: 100%;  height: 300px ;">
		<div class="d-flex row justify-content-center align-items-center align-items-center " style="height:550px">
			<form action="#" method="post" class="col-6" style="background : white;  opacity: 0.9">
				@csrf
				<div class="row">
					<div class="col-12" style="background: #777777; color: white">
						<h4 class="text-center pt-3"><strong >Recuperar Contraseña</strong></h4>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-12 pb-3 pt-3">
							<input type="submit" value="Enviar" class="btn btn-primary mx-auto pl-5 pr-5 w-100">
					</div>
				</div>

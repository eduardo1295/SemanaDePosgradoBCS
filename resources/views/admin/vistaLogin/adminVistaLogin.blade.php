            ...
            <div class="form-group col-md-6 ">
                ...
                <div class="row">
                    <div id="imagenAnterior" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <img  src="{{ asset("/storage/img/fondo/".$datos[0].'/?'.date('H:i:s')) }}" alt="" id="imgslide" class="img-fluid mx-auto" style="height:250px">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group col-md-6 ">
                    ...
                    <div class="row">
                        <div id="imagenAnterior" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <img src="{{ asset("/storage/img/fondo/".$datos[1].'/?'.date('H:i:s')) }}" alt="" id="imgslide2" class="img-fluid mx-auto" style="height:250px">    
                            </div>
                        </div>
                    </div>
                </div>

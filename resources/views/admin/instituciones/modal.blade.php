                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="ciudad" name="ciudad"
                                placeholder="Ciudad de la institución" value="" required="" maxlength="30">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="calle" name="calle"
                                placeholder="Calle de la institución" value="" required="" maxlength="30">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="custom-file">
                                <input type="file" name="logo" class="custom-file-input" id="logo" lang="es"  accept="image/x-png,image/gif,image/jpeg" onchange="readURL(this,'vistaPrevia');mostrar('nuevoLogo');">
